> Cópia derivada de `DOCOPS.md` da árvore de trabalho para v1.2.0. Revisão-base: `526485a6`; conteúdo novo pode ainda não estar commitado.
> SHA-256 da fonte antes da adaptação dos links: `3c09a8a9780e80eb44809e211a2b4263307f9181ff26b5500e7074eafb6494d9`. [URL da versão alvo](https://github.com/victorsmelo/aios-vmelo/blob/v1.2.0/DOCOPS.md); a URL não comprova publicação.
...
2. Comparar a proposta com os documentos relacionados e registrar decisões estruturais em [Decisões](https://github.com/victorsmelo/aios-vmelo/blob/v1.2.0/docs/decisions/README.md).
...
Ver [checklist de integridade](https://github.com/victorsmelo/aios-vmelo/blob/v1.2.0/docs/LINK_INTEGRITY_CHECKLIST.md) e [histórico de alterações](https://github.com/victorsmelo/aios-vmelo/blob/v1.2.0/CHANGELOG.md).
