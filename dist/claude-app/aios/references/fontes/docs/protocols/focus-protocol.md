> Cópia derivada de `docs/protocols/focus-protocol.md` da árvore de trabalho para v1.2.0. Revisão-base: `526485a6`; conteúdo novo pode ainda não estar commitado.
> SHA-256 da fonte antes da adaptação dos links: `995eac3c22f3069b6647a6bbf0670cdd6ac9f7cd556b3bca4a27acb187f4425a`. [URL da versão alvo](https://github.com/victorsmelo/aios-vmelo/blob/v1.2.0/docs/protocols/focus-protocol.md); a URL não comprova publicação.
...
Ver [skills](https://github.com/victorsmelo/aios-vmelo/blob/v1.2.0/docs/skills/README.md) e [DOCOPS](https://github.com/victorsmelo/aios-vmelo/blob/v1.2.0/DOCOPS.md).
