> Cópia derivada de `DOCOPS.md` para v1.3.1. Revisão-base: `fad18c4624293c4408487efb95e5103a5cfe470b`.
> SHA-256 da fonte antes da adaptação dos links: `3c09a8a9780e80eb44809e211a2b4263307f9181ff26b5500e7074eafb6494d9`. [URL da fonte](https://github.com/victorsmelo/aios-vmelo/blob/main/DOCOPS.md); consultar a nota da versão para o estado de publicação.
...
2. Comparar a proposta com os documentos relacionados e registrar decisões estruturais em [Decisões](https://github.com/victorsmelo/aios-vmelo/blob/main/docs/decisions/README.md).
...
Ver [checklist de integridade](https://github.com/victorsmelo/aios-vmelo/blob/main/docs/LINK_INTEGRITY_CHECKLIST.md) e [histórico de alterações](https://github.com/victorsmelo/aios-vmelo/blob/main/CHANGELOG.md).
