...
As 20 definições devem seguir integralmente o [modelo oficial](https://github.com/victorsmelo/aios-vmelo/blob/v1.2.0/docs/templates/persona-template.md). Não existe versão mínima reduzida para personas ativas.
